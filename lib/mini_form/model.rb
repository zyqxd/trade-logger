...
module MiniForm
  module Model
    ...
    module ClassMethods
      ...
      def model( # rubocop:disable Metrics/ParameterLists
        name,
        attributes: [],
        read: [],
        prefix: nil,
        ...
        unless attributes.empty?
          attributes(*attributes, delegate: name, prefix: prefix,
                                  allow_nil: allow_nil)
        end

        delegate(*read, to: name, prefix: prefix, allow_nil: nil)

        # NOTE(DZ): Not sure if we need yet
